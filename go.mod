...
require (
	buf.build/gen/go/gportal/gportal-cloud/grpc/go v1.3.0-20230914063750-eecfce952b80.2
	buf.build/gen/go/gportal/gportal-cloud/protocolbuffers/go v1.31.0-20230914063750-eecfce952b80.2
