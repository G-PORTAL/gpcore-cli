...
require (
	buf.build/gen/go/gportal/gpcore/grpc/go v1.5.1-20251103085422-b156624a826d.2
...
require (
	...
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.36.11-20240401165935-b983156c5e99.1 // indirect
