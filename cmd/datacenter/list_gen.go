...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		resp, err := conn.CloudClient().ListDatacenters(cmd.Context(), &cloudv1.ListDatacentersRequest{})
		if err != nil {
			return err
		}
		...
		// Format list
		jsonData, err := json.MarshalIndent(resp.Datacenters, "", "  ")
		if err != nil {
			return err
		}
...
func init() {
	...
	RootDatacenterCommand.AddCommand(listCmd)
}
