...
var sshKeysCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		resp, err := conn.CloudClient().ListProjectSSHKeys(cmd.Context(), &cloudv1.ListProjectSSHKeysRequest{
		...
		// Format list
		jsonData, err := json.MarshalIndent(resp.Keys, "", "  ")
		if err != nil {
			return err
		}
...
func init() {
	...
	RootProjectCommand.AddCommand(sshKeysCmd)
}
